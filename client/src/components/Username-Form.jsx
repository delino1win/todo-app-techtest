...
export default function UsernameForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-[70%] flex flex-col items-center gap-5">
    ...
    <button type="submit" className="btn btn-glass bg-blue-100 w-[70%] hover:btn-info">Submit</button>
    </form>
  );
}
